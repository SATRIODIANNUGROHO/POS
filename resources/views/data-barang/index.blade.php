        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                <button onclick="modalAction('{{ url('/data-barang/import') }}')" class="btn btn-sm btn-info mt-1">Import
                    Barang</button>
                <a href="{{ url('/data-barang/export_excel') }}" class="btn btn-sm btn-primary mt-1">Export Barang Excel</a>
                <a href="{{ url('/data-barang/export_pdf') }}" class="btn btn-sm btn-warning mt-1">Export Barang PDF</a>
