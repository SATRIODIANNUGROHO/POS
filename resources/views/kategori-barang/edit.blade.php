    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            @empty($kategori)
                ...
                <a href="{{ url('kategori-barang') }}" class="btn btn-sm btn-default mt-2">Kembali</a>
            @else
                <form method="POST" action="{{ url('/kategori-barang/' . $kategori->kategori_id) }}" class="form-horizontal">
                    @csrf
                    {!! method_field('PUT') !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            ...
                            <a class="btn btn-sm btn-default ml-1" href="{{ url('kategori-barang') }}">Kembali</a>
                        </div>
                    </div>
                </form>
            @endempty
