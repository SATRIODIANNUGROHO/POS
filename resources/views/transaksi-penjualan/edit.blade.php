...
@section('content')
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            <form action="{{ url('transaksi-penjualan/' . $transaksi->detail_id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="penjualan_id" id="penjualan_id" class="form-control"
                        value="{{ old('penjualan_id', $transaksi->penjualan_id) }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="barang_id" id="barang_id" class="form-control" required>
                        ...
                        @foreach ($barang as $item)
                            <option value="{{ $item->barang_id }}" {{ $item->barang_id == old('barang_id', $transaksi->barang_id) ? 'selected' : '' }}>
                                {{ $item->barang_nama }}
                            </option>
                        @endforeach
                    </select>
