...
@else
    <form action="{{ url('/transaksi-penjualan/' . $data->detail_id) }}" method="POST" id="form-delete">
        @csrf
        @method('DELETE')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-warning">
                        ...
                        Apakah Anda yakin ingin menghapus data transaksi di bawah ini?
                    </div>
                    <table class="table table-sm table-bordered table-striped">
                        <tr>
                            <th class="text-right col-4">ID Penjualan :</th>
                            <td class="col-8">{{ $data->penjualan_id }}</td>
                        </tr>
                        <tr>
