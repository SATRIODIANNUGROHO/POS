...
@else
    <form action="{{ url('/stok-barang/' . $stok->stok_id) }}" method="POST" id="form-edit">
        @csrf
        @method('PUT')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <select name="barang_id" id="barang_id" class="form-control" required>
                            ...
                            @foreach ($barangList as $b)
                                <option value="{{ $b->barang_id }}"
                                    {{ $b->barang_id == $stok->barang_id ? 'selected' : '' }}>
                                    {{ $b->barang_nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="stok_tanggal" id="stok_tanggal"
                            value="{{ $stok->stok_tanggal }}" class="form-control" required>
                        <small id="error-stok_tanggal" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label>Jumlah</label>
                        <input type="number" name="stok_jumlah" id="stok_jumlah"
                            value="{{ $stok->stok_jumlah }}" class="form-control" required>
